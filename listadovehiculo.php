...
$listado=$vehiculos->readvehiculo();
?>
           ...
           <div class="col-lg-12">
            <table id="example" class="table table-bordered  display nowrap" cellspacing="0" width="100%">
                ...
                ?>
                    ...
                    <a href="deletevehiculo.php?$id=<?php echo $placa;?>"name="delete" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a></td>
                    </tr>   
                <?php
}
?>
